...
import { AddRefresquitoApiKey1795000000000 } from './migration/postgres/1795000000000-AddRefresquitoApiKey'
import { AddRefresquitoSecretManager1795000000001 } from './migration/postgres/1795000000001-AddRefresquitoSecretManager'
import { AddRefresquitoGitRepo1795000000002 } from './migration/postgres/1795000000002-AddRefresquitoGitRepo'
...
export const getMigrations = (): (new () => Migration)[] => {
    const migrations = [
        ...
        AddRefresquitoApiKey1795000000000,
        AddRefresquitoSecretManager1795000000001,
        AddRefresquitoGitRepo1795000000002,
    ]
    return migrations
}
