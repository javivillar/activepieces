...
export const refresquitoGlobalConnectionModule: FastifyPluginAsyncZod = async (app) => {
    await app.register(refresquitoGlobalConnectionController, { prefix: '/v1/global-connections' })
}

const refresquitoGlobalConnectionController: FastifyPluginAsyncZod = async (app) => {
