...
export enum AppSystemProp {
    ...
    KEYCLOAK_SSO_ENABLED = 'KEYCLOAK_SSO_ENABLED',
    KEYCLOAK_ISSUER_URL = 'KEYCLOAK_ISSUER_URL',
    KEYCLOAK_CLIENT_ID = 'KEYCLOAK_CLIENT_ID',
    KEYCLOAK_CLIENT_SECRET = 'KEYCLOAK_CLIENT_SECRET',
    KEYCLOAK_ADMIN_GROUP = 'KEYCLOAK_ADMIN_GROUP',
    KEYCLOAK_USER_GROUP = 'KEYCLOAK_USER_GROUP',
    KEYCLOAK_EDITOR_GROUP = 'KEYCLOAK_EDITOR_GROUP',
    KEYCLOAK_VIEWER_GROUP = 'KEYCLOAK_VIEWER_GROUP',
    KEYCLOAK_SHARED_PROJECT_ID = 'KEYCLOAK_SHARED_PROJECT_ID',
